# Template file: the Version field and the %changelog below are generated by
# `make gen-spec` from the git tag and git log. Do not build this file directly.
...
of recipients and mail metadata from a TOML configuration file, substitutes
